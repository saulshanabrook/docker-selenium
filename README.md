...
``` bash
$ docker run -d -p 4444:4444 -v /dev/shm:/dev/shm selenium/standalone-chrome:3.4.0-francium
```
...
``` bash
$ docker run -d -p 4444:4444 selenium/standalone-chrome:3.4.0-francium
# OR
$ docker run -d -p 4444:4444 selenium/standalone-firefox:3.4.0-francium
```
...
$ docker run -d --link selenium-hub:hub selenium/node-chrome:3.4.0-francium
$ docker run -d --link selenium-hub:hub selenium/node-firefox:3.4.0-francium
```
...
``` bash
$ docker run -d -p 4444:4444 -e JAVA_OPTS=-Xmx512m --name selenium-hub selenium/hub:3.4.0-francium
```
...
``` bash
$ docker run -d -p 4444:4444 -e SE_OPTS="-debug true" --name selenium-hub selenium/hub:3.4.0-francium
```
...
``` bash
$ docker run -d -e PHANTOMJS_OPTS="--ignore-ssl-errors=true" --link selenium-hub:hub selenium/node-phantomjs:3.4.0-francium
```
...
``` bash
$ docker run -d --name selenium-hub -p 4444:4444 selenium/hub:3.4.0-francium
$ CH=$(docker run --rm --name=ch \
    --link selenium-hub:hub -v /e2e/uploads:/e2e/uploads \
    selenium/node-chrome:3.4.0-francium)
```
...
$ FF=$(docker run --rm --name=fx \
    --link selenium-hub:hub -v /e2e/uploads:/e2e/uploads \
    selenium/node-firefox:3.4.0-francium)
```
...
``` bash
$ docker run -d -P -p <port4VNC>:5900 --link selenium-hub:hub selenium/node-chrome-debug:3.4.0-francium
$ docker run -d -P -p <port4VNC>:5900 --link selenium-hub:hub selenium/node-firefox-debug:3.4.0-francium
```
e.g.:
``` bash
$ docker run -d -P -p 5900:5900 --link selenium-hub:hub selenium/node-chrome-debug:3.4.0-francium
$ docker run -d -P -p 5901:5900 --link selenium-hub:hub selenium/node-firefox-debug:3.4.0-francium
```
...
And for standalone:
``` bash
$ docker run -d -p 4444:4444 -p <port4VNC>:5900 selenium/standalone-chrome-debug:3.4.0-francium
# OR
$ docker run -d -p 4444:4444 -p <port4VNC>:5900 selenium/standalone-firefox-debug:3.4.0-francium
```
or
``` bash
$ docker run -d -p 4444:4444 -p 5900:5900 selenium/standalone-chrome-debug:3.4.0-francium
# OR
$ docker run -d -p 4444:4444 -p 5901:5900 selenium/standalone-firefox-debug:3.4.0-francium
```
